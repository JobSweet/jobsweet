...
This starter project serves all static files from the /public directory. To reference these files in your client side code, you only need to prefix /public, i.e. /public/css/style.css.  You can also remove the prefix which would mean you can server the same css file as /css/style.css.  The fallthrough option makes client errors fall-through as just unhandled requests which allows us to have a 404 handler immediately after our static file serving code.
